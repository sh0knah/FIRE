            ...
            <div id="FutureContributions" className="Section-Body">
                ...
                <div className="Section-Subsection Grid2">
                    <div className="SubGrid2">
                        ...
                        <label htmlFor="DOB" className="Field-label G1">Year of birth: </label><input type="number" onChange={e => setState({ ...state, dob: e.target.value })} className="Field-value Date G2" id="DOB" value={state.dob} />
                        <label htmlFor="REGoal" className="Field-label G1">Retirement goal year: </label><input type="number" onChange={e => setState({ ...state, regoal: e.target.value })} className="Field-value Date G2" id="REGoal" value={state.regoal} />
                    ...
                    <div className="SubGrid2">
                        ...
                        <label htmlFor="DOB_Parter" className="Field-label G1">Year of birth: </label><input type="number" onChange={e => setState({ ...state, dob_Partner: e.target.value })} className="Field-value Date G2" id="DOB_Partner" value={state.dob_Partner} />
                        <label htmlFor="REGoal_Partner" className="Field-label G1">Retirement goal year: </label><input type="number" onChange={e => setState({ ...state, regoal_Partner: e.target.value })} className="Field-value Date G2" id="REGoal_Partner" value={state.regoal_Partner} />
